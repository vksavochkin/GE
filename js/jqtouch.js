    ...
    $.jQTouch = function(options) {
        ...
        function init(options) {
            ...
            var defaults = {
                ...
                backSelector: '.back1, .cancel, .goback',
                ...
                icon: null,
                touchSelector: 'a1, .touch',
                popSelector: '.pop',
                preloadImages: false,
                slideSelector: 'body > * > ul li a1',
            ...
            if (jQTSettings.fixedViewport) {
                hairextensions += '<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0;"/>';
					//hairextensions += '<meta name ="viewport" content ="user-scalable=no,width=device-width" />';
            }
            // Set full-screen
