var InApp = {
	...
	/**
	 * @param item
	 * @param {string} item.localizedDescription
	 * @param {string} item.localizedTitle
	 * @param {string} item.price
	 * @param {string} item.productIdentifier
	 * @returns {string}
	 */
	 ...
	 *
	 * @param result
	 * @param {number} result.quantity
	 * @param {string} result.productIdentifier
	 * @param {string} result.transactionReceipt
	 */
